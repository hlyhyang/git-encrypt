...
def admin_func():
    ...
    if(input("Generate key to encrypt your file? Enter y to continue enter any other keys to continue ")=='y'):
    ...
    if(input("Share your file with others? Enter y to continue enter any other keys to quit ")=='y'):
